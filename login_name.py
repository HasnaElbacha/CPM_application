...
def main_login_name():
    ...
    login=Button(lgn_frame,image=photo_login, font=('yu gothic ui',13,'bold'),width=210,height=50,bd=0,bg='#040405',cursor='hand2',activebackground='#040405',command=passloginpwd)
